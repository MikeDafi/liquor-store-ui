export interface Product {
  id: string;
  code?: string; // Barcode/UPC for image lookups
  name: string;
  category: string;
  subcategory: string;
  price: number;
...
export const categories = [
  { id: 'whiskey', name: 'Whiskey', icon: '🥃', image: 'https://images.unsplash.com/photo-1527281400683-1aae777175f8?w=800&q=80' },
  { id: 'vodka', name: 'Vodka', icon: '🍸', image: 'https://images.unsplash.com/photo-1608885898957-a559228e8749?w=800&q=80' },
  { id: 'wine', name: 'Wine', icon: '🍷', image: 'https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?w=800&q=80' },
  ...
  { id: 'drinks', name: 'Drinks', icon: '🥤', image: 'https://images.unsplash.com/photo-1558645836-e44122a743ee?w=800&q=80' },
  { id: 'tobacco', name: 'Tobacco', icon: '🚬', image: 'https://images.unsplash.com/photo-1569529465841-dfecdab7503b?w=800&q=80' },
